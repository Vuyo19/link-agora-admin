    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative lg:w-2/5 sm:w-3/5 w-11/12 bg-gray-100 rounded-xl mx-auto border p-10 shadow-sm">
        ...
        <div>
          ...
          <div className="rounded-lg border-[#ffcaca] border-2 bg-[#fff1f1] text-center mt-6 mb-6">
  <p className="text-xs text-[#f08080] font-bold mt-3 mb-3">This event was declined due to...</p>
</div>
        ...
        <hr className="h-0.5 border-t-0 bg-gray-400 opacity-40" />
        <p className="text-xs font-bold mt-6 mb-6 flex justify-center items-center">
          {" "}
          Event record will automatically be deleted after 30 days.
        </p>
        {/* //---- endof ----// */}
      </div>
...
export default DeclinedEventModal;
